...
1b. demo 통합 시나리오 구현: `corp_dl_agent/demo.py` + `commands/demo_cmd.py` (tests/test_cli_basic.py 의 ALLOWED_MISSING_BEFORE_INTEGRATION 에서 demo_cmd 제거) → `python -m corp_dl_agent demo --offline --device cpu --output-dir workspace/demo-full`.
