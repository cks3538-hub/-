...
1. Windows 개인 PC 에서 TARGET_OFFLINE_TESTED 수행: `DIA_4.0.0_win-x64-cp312-cpu.zip` (SHA-256 b8a3218aa724fa786b557a8434c0b4e819387084dea8df34fb67687e4eafc59a) 을 새 폴더에 풀고 `scripts\00_Preflight.cmd → 01_Verify.cmd → 02_Install.cmd → 04_SelfTest.cmd → launch.cmd demo --offline --device cpu` 실행. 결과 JSON 을 `python scripts\acceptance.py --zip <zip> --evidence-dir <폴더> --out <폴더> --status TARGET_OFFLINE_TESTED=PASS=...` 로 기록.
