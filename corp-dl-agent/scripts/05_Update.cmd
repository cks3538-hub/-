...
setlocal
rem ---------------------------------------------------------------------------
rem  05_Update: install this package as a new release (lease check, DB backup, migration plan, activate on success)
...
echo [05] update
%PYCMD% "%SCRIPT_DIR%upgrade.py" --package "%PKG_DIR%" --install-root "%DIA_INSTALL_ROOT%" %DATA_ARG% %*
set "EC=%ERRORLEVEL%"
