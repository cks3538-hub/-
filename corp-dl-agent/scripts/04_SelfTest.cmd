...
setlocal
rem ---------------------------------------------------------------------------
rem  04_SelfTest: self-test with the installed venv (units 1.0 kg, sqlite, document libs, torch CPU)
...
echo [04] self-test
%PYCMD% "%SCRIPT_DIR%selftest.py" --install-root "%DIA_INSTALL_ROOT%" %DATA_ARG% -- %*
set "EC=%ERRORLEVEL%"
