...
setlocal
rem ---------------------------------------------------------------------------
rem  00_Preflight: python/venv/ensurepip/disk/write-permission diagnosis + target_profile.min.json
...
echo [00] preflight
%PYCMD% "%SCRIPT_DIR%preflight.py" --install-root "%DIA_INSTALL_ROOT%" %DATA_ARG% --package "%PKG_DIR%" %*
set "EC=%ERRORLEVEL%"
