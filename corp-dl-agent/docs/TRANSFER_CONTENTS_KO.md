...
| 파일 | 설명 |
|---|---|
| `DIA_4.0.0_win-x64-cp312-cpu.zip` | 반입 패키지 (package_kind=CPU_OFFLINE, 219,758,428 bytes, 254 항목). SHA-256 `b8a3218aa724fa786b557a8434c0b4e819387084dea8df34fb67687e4eafc59a` |
...
| TARGET_OFFLINE_TESTED | NOT_RUN (Windows 환경 없음). 같은 소스의 Linux 프로파일 ZIP(`DIA_4.0.0_linux-x64-cp312-cpu.zip`, SHA-256 `42f0c54c16b483e3b9420298e1df120c003fd83f82b1e12890ef935635c2f8a3`, 3.1 GB) 은 새 환경 rehearsal PASS (12 단계) — `DIA_4.0.0_linux-x64-cp312-cpu.acceptance.json` | acceptance.json |
