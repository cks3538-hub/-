...
검증 상태: HOST_CORE_TESTED=IN_PROGRESS, TARGET_BUNDLE_PREPARED=NOT_RUN(wheel 확보됨, lock/manifest 미생성), TARGET_OFFLINE_TESTED=NOT_RUN, CORP_INSTALLED=NOT_RUN, CORP_INTEGRATED=NOT_RUN, BUSINESS_VALIDATED=NOT_RUN
